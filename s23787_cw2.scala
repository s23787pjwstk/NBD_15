object s21843_cwicz2 extends App {

  println("Zadanie 1")

  def zad1(dzien: String): String = dzien match {
    case "Poniedziałek" => s"Praca"
    case "Wtorek" => "Praca"
    case "Środa" => "Praca"
    case "Czwartek" => "Praca"
    case "Piątek" => "Praca"
  ...
  val o1 = new Osoba5("Andrzej","Duda") with Student
  val o2 = new Osoba5("Rafał","Trzaskowski") with Pracownik
  o2.pensja = 10000
  val o3= new Osoba5("Szymon", "Hołownia") with Nauczyciel
  o3.pensja = 10000
  println(o1.toString)
  println(o2.toString)
  println(o3.toString)
